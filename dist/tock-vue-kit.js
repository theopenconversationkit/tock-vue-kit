...
import { effectScope as Qt, ref as B, markRaw as Gt, hasInjectionContext as ms, inject as Jt, watch as bs, reactive as ys, isRef as Oe, isReactive as Yt, toRaw as Ts, getCurrentScope as vs, onScopeDispose as ks, nextTick as Es, toRefs as Ss, computed as Xt, defineComponent as F, openBlock as p, createElementBlock as T, unref as l, createTextVNode as he, toDisplayString as H, normalizeClass as be, createCommentVNode as A, normalizeStyle as fe, createElementVNode as M, withModifiers as As, withDirectives as Cs, vModelText as Ds, Fragment as de, renderList as ct, createBlock as Z, withCtx as Is, createVNode as Zt, onMounted as Ns, createApp as _s } from "vue";
var Ls = !1;
/*!
 * pinia v2.1.7
...
function ns(e, t, s = {}, i, n, a) {
  ...
  !a && !y && (i.state.value[e] = {}), B({});
  let k;
  function D(C) {
    let E;
    f = b = !1, typeof C == "function" ? (C(i.state.value[e]), E = {
      type: ye.patchFunction,
      storeId: e,
      events: h
    }) : (yt(i.state.value[e], C), E = {
      type: ye.patchObject,
      payload: C,
      storeId: e,
      events: h
  ...
  function v(C, E) {
    return function() {
      ...
      let J;
      try {
        J = E.apply(this && this.$id === e ? this : I, z);
      } catch (O) {
        throw ce(ee, O), O;
      }
      return J instanceof Promise ? J.then((O) => (ce(W, O), O)).catch((O) => (ce(ee, O), Promise.reject(O))) : (ce(W, J), J);
    };
  }
  const x = {
    _p: i,
    ...
    $reset: S,
    $subscribe(C, E = {}) {
      const z = Ht(g, C, E.detached, () => W()), W = o.run(() => bs(() => i.state.value[e], (ee) => {
        (E.flush === "sync" ? b : f) && C({
          storeId: e,
          type: ye.direct,
          events: h
  ...
  i._s.set(e, I);
  const V = (i._a && i._a.runWithContext || Rs)(() => i._e.run(() => (o = Qt()).run(t)));
  for (const C in V) {
    const E = V[C];
    if (Oe(E) && !Ps(E) || Yt(E))
      a || (y && xs(E) && (Oe(E) ? E.value = y[C] : yt(E, y[C])), i.state.value[e][C] = E);
...
const Us = "main", Mt = "main_storage", zs = () => ({
  ...
  const e = Jt(is), t = U.getInstance().options, s = B(i());
  function i() {
  ...
  setup(e) {
    const t = U.getInstance().options, s = ae(), i = t.preferences.questionBar.maxUserInputLength, n = B(null), a = B("");
    function o() {
...
j.prototype = {
  ...
  tt(e, t, s, i) {
    ...
    const a = t;
    let o, r = n.go(e);
    if (r ? (o = new j(), ge(o.j, r.j), o.jr.push.apply(o.jr, r.jr), o.jd = r.jd, o.t = r.t) : o = new j(), a) {
      if (i)
...
const m = (e, t, s, i, n) => e.ta(t, s, i, n), $ = (e, t, s, i, n) => e.tr(t, s, i, n), jt = (e, t, s, i, n) => e.ts(t, s, i, n), c = (e, t, s, i, n) => e.tt(t, s, i, n), Y = "WORD", At = "UWORD", Ee = "LOCALHOST", Ct = "TLD", Dt = "UTLD", Le = "SCHEME", ue = "SLASH_SCHEME", _t = "NUM", os = "WS", Lt = "NL", Te = "OPENBRACE", ve = "CLOSEBRACE", Re = "OPENBRACKET", we = "CLOSEBRACKET", xe = "OPENPAREN", Pe = "CLOSEPAREN", He = "OPENANGLEBRACKET", Me = "CLOSEANGLEBRACKET", Be = "FULLWIDTHLEFTPAREN", je = "FULLWIDTHRIGHTPAREN", Ue = "LEFTCORNERBRACKET", ze = "RIGHTCORNERBRACKET", $e = "LEFTWHITECORNERBRACKET", qe = "RIGHTWHITECORNERBRACKET", Ve = "FULLWIDTHLESSTHAN", We = "FULLWIDTHGREATERTHAN", Fe = "AMPERSAND", Ke = "APOSTROPHE", Qe = "ASTERISK", ne = "AT", Ge = "BACKSLASH", Je = "BACKTICK", Ye = "CARET", ie = "COLON", Ot = "COMMA", Xe = "DOLLAR", K = "DOT", Ze = "EQUALS", Rt = "EXCLAMATION", Q = "HYPHEN", et = "PERCENT", tt = "PIPE", st = "PLUS", nt = "POUND", it = "QUERY", wt = "QUOTE", xt = "SEMI", G = "SLASH", ke = "TILDE", at = "UNDERSCORE", rs = "EMOJI", ot = "SYM";
...
function rn(e) {
  ...
  const s = t.domain.concat([Fe, Qe, ne, Ge, Je, Ye, Xe, Ze, Q, _t, et, tt, st, nt, G, ot, ke, at]), i = [Ke, ie, Ot, K, Rt, it, wt, xt, He, Me, Te, ve, we, Re, xe, Pe, Be, je, Ue, ze, $e, qe, Ve, We], n = [Fe, Ke, Qe, Ge, Je, Ye, Xe, Ze, Q, Te, ve, et, tt, st, nt, it, G, ot, ke, at], a = q(), o = c(a, ke);
  ...
  const x = c(v, ie), I = q(Ne);
  m(x, t.numeric, I);
  const L = q(Ne), V = q();
  m(L, s, L), m(L, i, V), m(V, s, L), m(V, i, V), c(v, G, L), c(I, G, L);
  const C = c(u, ie), E = c(f, ie), z = c(E, G), W = c(z, G);
  m(u, t.domain, r), c(u, K, N), c(u, Q, S), m(f, t.domain, r), c(f, K, N), c(f, Q, S), m(C, t.domain, L), c(C, G, L), m(W, t.domain, L), m(W, s, L), c(W, G, L);
  const ee = [
    [Te, ve],
    // {}
    [Re, we],
  ...
  for (let pe = 0; pe < ee.length; pe++) {
    const [Ae, J] = ee[pe], O = c(L, Ae);
    c(V, Ae, O), c(O, J, L);
    const re = q(Ne);
    m(O, s, re);
    const me = q();
    m(O, i), m(re, s, re), m(re, i, me), m(me, s, re), m(me, i, me), c(re, J, L), c(me, J, L);
  }
  return c(a, Ee, v), c(a, Lt, on), {
    start: a,
    tokens: cs
  };
}
...
function ln() {
  P.scanner = sn(P.customSchemes);
  for (let e = 0; e < P.tokenQueue.length; e++)
    P.tokenQueue[e][1]({
      scanner: P.scanner
    });
  P.parser = rn(P.scanner.tokens);
...
function un(e) {
  return P.initialized || ln(), cn(P.parser.start, e, nn(P.scanner.start, e));
}
var hn = {
...
const us = "LinkifyResult", rt = "StartTag", hs = "EndTag", It = "Chars", Sn = "Comment", An = "Doctype";
function Cn(e, t) {
  t === void 0 && (t = {});
  const s = En(e), i = [], n = [], a = new Pt(t, Nn);
...
const On = /* @__PURE__ */ F({
  ...
  setup(e) {
    const t = U.getInstance().options, s = e;
  ...
  setup(e) {
    U.getInstance().options;
    const t = e;
    function s() {
      return Cn(t.message.text, { target: "_blank" });
    }
    return (i, n) => {
      var a;
      return p(), T(de, null, [
...
}), Bn = { class: "tvk-card" }, jn = ["src", "alt"], Un = { key: 1 }, zn = { key: 2 }, $n = { key: 3 }, ds = /* @__PURE__ */ F({
  __name: "message-card",
  props: {
    card: {
      type: Object
    ...
    return (u, f) => {
      ...
      return p(), T("div", Bn, [
        ...
        (y = s.card) != null && y.title ? (p(), T("div", Un, [
          M("strong", null, H((k = s.card) == null ? void 0 : k.title), 1)
        ])) : A("", !0),
        (D = s.card) != null && D.subTitle ? (p(), T("div", zn, H((S = s.card) == null ? void 0 : S.subTitle), 1)) : A("", !0),
        (v = (N = s.card) == null ? void 0 : N.file) != null && v.description ? (p(), T("div", $n, H((I = (x = s.card) == null ? void 0 : x.file) == null ? void 0 : I.description), 1)) : A("", !0)
      ]);
    };
  }
    ...
    return (k, D) => (p(), T(de, null, [
      M("div", {
        ...
        M("div", {
          ...
          (p(!0), T(de, null, ct(s.value, (S) => (p(), T("div", {
      ...
      M("div", { class: "tvk-carousel-controls" }, [
        M("button", {
          class: "tvk-btn",
          onClick: d
        }, " prev "),
  ...
  setup(e) {
    return U.getInstance().options, (t, s) => "Image type not yet implemented";
  }
}), Wn = {
  key: 0,
...
}, Jn = { class: "tvk-message-header-label-user" }, Yn = { class: "tvk-message-header-label-bot" }, Xn = /* @__PURE__ */ M("div", { class: "tvk-message-header-line-break" }, null, -1), Zn = {
  key: 1,
  ...
  setup(e) {
    ...
    return (i, n) => s.message.author !== l(_).user || !l(t).preferences.messages.message.hideUserMessages ? (p(), T("div", {
      ...
      l(t).preferences.messages.message.header.display && s.message.author !== l(_).app ? (p(), T("div", Wn, [
        ...
        l(t).preferences.messages.message.header.label.display ? (p(), T("div", Gn, [
          M("span", Jn, H(l(t).wording.messages.message.header.labelUser), 1),
          M("span", Yn, H(l(t).wording.messages.message.header.labelBot), 1)
        ])) : A("", !0)
      ])) : A("", !0),
      Xn,
      s.message.author !== l(_).app ? (p(), T("div", Zn, [
        ...
        s.message.type === l(w).card ? (p(), Z(ds, {
          key: 1,
          card: s.message
        }, null, 8, ["card"])) : A("", !0),
      ...
      s.message.author === l(_).app ? (p(), T("div", ei, [
        s.message.type === l(w).loader ? (p(), T("div", ti)) : A("", !0)
      ])) : A("", !0)
    ], 2)) : A("", !0);
  }
}), ni = /* @__PURE__ */ F({
...
}), ii = { class: "tvk-wrapper" }, ai = /* @__PURE__ */ F({
  __name: "App",
  setup(e) {
    const t = U.getInstance().options, s = ae();
    return (i, n) => (p(), T("main", ii, [
      l(s).getMessages.length || !l(t).preferences.messages.hideIfNoMessages ? (p(), Z(ni, { key: 0 })) : A("", !0),
      Zt(Ks)
    ]));
  }
});
...
function li(e, t, s) {
  const i = _s(ai);
  i.provide(is, t), U.clearInstance(), U.getInstance(s);
  const n = Os();
  return i.use(n), i.mount(e), oi(), i;
}
export {
  li as renderChat
};
