...
This will fail in production.`);
  ...
  const useMainStore = defineStore(MAIN_STORE_NAME, () => {
    ...
    const getMessages = vue.computed(
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$7, [
          vue.createElementVNode("ul", _hoisted_2$6, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.files, (file, index) => {
              return vue.openBlock(), vue.createElementBlock("li", {
                class: vue.normalizeClass(["tvk-upload-file-preview", {
                  "not-allowed": !file.typeAllowed || !file.sizeAllowed || index >= vue.unref(appOptions).preferences.questionBar.uploadFiles.maxFiles
                }])
              }, [
                vue.createElementVNode("div", _hoisted_3$4, [
                  !file.typeAllowed || file.status === vue.unref(FileUploadStatus).error ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_4$4)) : file.status === vue.unref(FileUploadStatus).loading ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_5$4)) : file.status === vue.unref(FileUploadStatus).completed ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_6$2)) : file.typelabel === "pdf" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_7$2)) : file.typelabel === "json" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_8$2)) : file.typelabel === "csv" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_9$2)) : file.typelabel === "html" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_10$2)) : file.typelabel === "txt" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_11$1)) : file.typelabel === "rtf" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_12$1)) : file.typelabel === "odt" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_13$1)) : file.typelabel === "doc" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_14$1)) : file.typelabel === "docx" ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_15$1)) : (vue.openBlock(), vue.createElementBlock("i", _hoisted_16)),
                  vue.createTextVNode(" " + vue.toDisplayString(file.status) + " ", 1),
                  vue.createElementVNode("span", _hoisted_17, vue.toDisplayString(file.name), 1),
                  vue.createElementVNode("small", _hoisted_18, "(" + vue.toDisplayString(vue.unref(humanFileSize)(file.size)) + ")", 1),
                  index >= vue.unref(appOptions).preferences.questionBar.uploadFiles.maxFiles ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_19, [
                    vue.createElementVNode("small", _hoisted_20, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.filesNumberLimitWarning) + " " + vue.toDisplayString(vue.unref(appOptions).preferences.questionBar.uploadFiles.maxFiles), 1)
                  ])) : !file.sizeAllowed ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_21, [
                    vue.createElementVNode("small", _hoisted_22, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.filesSizeWarning) + " (max file size " + vue.toDisplayString(vue.unref(humanFileSize)(
                      vue.unref(appOptions).preferences.questionBar.uploadFiles.maxFileSize
                    )) + ") ", 1)
                  ])) : !file.typeAllowed ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_23, [
                    vue.createElementVNode("small", _hoisted_24, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.filesFormatWarning), 1)
                  ])) : vue.createCommentVNode("", true)
                ]),
                file.status === vue.unref(FileUploadStatus).pending ? (vue.openBlock(), vue.createElementBlock("button", {
                  key: 0,
                ...
                vue.withDirectives(vue.createElementVNode("div", { class: "status-indicator loading" }, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.fileUploadLoading), 513), [
                  [vue.vShow, file.status === vue.unref(FileUploadStatus).loading]
                ]),
                vue.withDirectives(vue.createElementVNode("div", { class: "status-indicator success" }, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.fileUploadCompleted), 513), [
                  [vue.vShow, file.status === vue.unref(FileUploadStatus).completed]
                ]),
                vue.withDirectives(vue.createElementVNode("div", { class: "status-indicator warning" }, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.fileUploadError), 513), [
                  [vue.vShow, file.status === vue.unref(FileUploadStatus).error]
                ])
              ], 2);
            }), 256))
          ]),
          vue.createElementVNode("div", _hoisted_26, [
            vue.createElementVNode("div", _hoisted_27, [
              ...
              }, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.uploadCancel), 9, _hoisted_28),
              vue.createElementVNode("button", {
              ...
              }, vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadFilesList.uploadSubmit), 9, _hoisted_29)
            ])
          ])
        ]);
      };
  ...
  const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const fileInput2 = vue.ref(null);
      const typedChars = vue.ref("");
      const dropZoneActive = vue.ref(false);
      const uploadInProgress = vue.ref(false);
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          onDragenter: vue.withModifiers(setDropZoneActive, ["prevent"]),
          onDragover: vue.withModifiers(setDropZoneActive, ["prevent"]),
          onDragleave: vue.withModifiers(setDropZoneInactive, ["prevent"]),
          "data-active": dropZoneActive.value
        }, [
          vue.unref(files).length ? (vue.openBlock(), vue.createBlock(_sfc_main$b, {
            key: 0,
            files: vue.unref(files),
            uploadInProgress: uploadInProgress.value,
            onRemove: vue.unref(removeFile),
            onCancel: onCancelUpload,
            onUpload: onUploadFiles
          }, null, 8, ["files", "uploadInProgress", "onRemove"])) : vue.createCommentVNode("", true),
          !vue.unref(files).length ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
            ((_a = vue.unref(appOptions).preferences.questionBar.clearHistory) == null ? void 0 : _a.display) ? (vue.openBlock(), vue.createElementBlock("button", {
              ...
              !vue.unref(appOptions).preferences.questionBar.clearHistory.image && vue.unref(appOptions).preferences.questionBar.clearHistory.icon ? (vue.openBlock(), vue.createElementBlock("i", {
                key: 0,
                class: vue.normalizeClass(vue.unref(appOptions).preferences.questionBar.clearHistory.icon)
              }, null, 2)) : vue.createCommentVNode("", true),
              vue.unref(appOptions).preferences.questionBar.clearHistory.image ? (vue.openBlock(), vue.createElementBlock("img", {
                key: 1,
                src: vue.unref(appOptions).preferences.questionBar.clearHistory.image.src,
              ...
              }, null, 12, _hoisted_3$3)) : vue.createCommentVNode("", true),
            ...
            vue.createElementVNode("form", {
              ...
              vue.withDirectives(vue.createElementVNode("input", {
                ...
                rows: "1",
                maxlength: vue.unref(appOptions).preferences.questionBar.maxUserInputLength,
                placeholder: vue.unref(appOptions).wording.questionBar.input.placeholder,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => typedChars.value = $event)
              }, null, 8, _hoisted_4$3), [
                [vue.vModelText, typedChars.value]
              ]),
              vue.createElementVNode("div", _hoisted_5$3, vue.toDisplayString(nbTypedChars()) + "/" + vue.toDisplayString(vue.unref(maxChars)), 1)
            ], 32),
            vue.unref(appOptions).preferences.questionBar.uploadFiles.allow && vue.unref(appOptions).preferences.questionBar.uploadFiles.displayButton ? (vue.openBlock(), vue.createElementBlock("button", {
              key: 1,
              class: "tvk-btn tvk-question-bar-btn-upload-files",
              "aria-label": vue.unref(appOptions).wording.questionBar.uploadBrowseButtonAriaLabel,
              onClick: onOpenFileBrowser
            }, [
              !vue.unref(appOptions).preferences.questionBar.uploadFiles.image && vue.unref(appOptions).preferences.questionBar.uploadFiles.icon ? (vue.openBlock(), vue.createElementBlock("i", {
                key: 0,
                class: vue.normalizeClass(vue.unref(appOptions).preferences.questionBar.uploadFiles.icon)
              }, null, 2)) : vue.createCommentVNode("", true),
              vue.unref(appOptions).preferences.questionBar.uploadFiles.image ? (vue.openBlock(), vue.createElementBlock("img", {
                key: 1,
                src: vue.unref(appOptions).preferences.questionBar.uploadFiles.image.src,
                style: vue.normalizeStyle({
                  width: vue.unref(appOptions).preferences.questionBar.uploadFiles.image.width,
                  height: vue.unref(appOptions).preferences.questionBar.uploadFiles.image.height
                })
              }, null, 12, _hoisted_7$1)) : vue.createCommentVNode("", true),
              vue.createTextVNode(" " + vue.toDisplayString(vue.unref(appOptions).wording.questionBar.uploadBrowseButtonLabel), 1)
            ], 8, _hoisted_6$1)) : vue.createCommentVNode("", true),
            vue.unref(appOptions).preferences.questionBar.uploadFiles.allow && vue.unref(appOptions).preferences.questionBar.uploadFiles.displayButton ? (vue.openBlock(), vue.createElementBlock("input", {
              key: 2,
              type: "file",
              class: "file-input",
              ref_key: "fileInput",
              ref: fileInput2,
              multiple: vue.unref(appOptions).preferences.questionBar.uploadFiles.maxFiles > 1,
              onChange: onFileInputChanged
            }, null, 40, _hoisted_8$1)) : vue.createCommentVNode("", true),
            vue.createElementVNode("button", {
              disabled: !typedChars.value.trim().length || userInputExceedLenth(),
              class: "tvk-btn tvk-question-bar-btn-submit",
              "aria-label": vue.unref(appOptions).wording.questionBar.submitAriaLabel,
              onClick: onSubmit
            }, [
              !vue.unref(appOptions).preferences.questionBar.submit.image && vue.unref(appOptions).preferences.questionBar.submit.icon ? (vue.openBlock(), vue.createElementBlock("i", {
                key: 0,
                class: vue.normalizeClass(vue.unref(appOptions).preferences.questionBar.submit.icon)
              }, null, 2)) : vue.createCommentVNode("", true),
              vue.unref(appOptions).preferences.questionBar.submit.image ? (vue.openBlock(), vue.createElementBlock("img", {
                key: 1,
                src: vue.unref(appOptions).preferences.questionBar.submit.image.src,
                style: vue.normalizeStyle({
                  width: vue.unref(appOptions).preferences.questionBar.submit.image.width,
                  height: vue.unref(appOptions).preferences.questionBar.submit.image.height
                })
              }, null, 12, _hoisted_10$1)) : vue.createCommentVNode("", true),
              vue.createTextVNode(" " + vue.toDisplayString(vue.unref(appOptions).wording.questionBar.submit), 1)
            ], 8, _hoisted_9$1)
  ...
  const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        }, vue.toDisplayString(props.button.title), 1);
      };
    }
  });
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, [
          ...
          props.footnote.content ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$2, [
            vue.createElementVNode("div", {
              ...
              ref: contentTxt,
              style: vue.normalizeStyle({
                "--tvk-clamp-nb-line": vue.unref(appOptions).preferences.messages.footNotes.clampSourceContentNbLines
              }),
            ...
            }, vue.toDisplayString(vue.unref(appOptions).wording.messages.message.footnotes.showMoreLink), 1)) : vue.createCommentVNode("", true)
          ])) : vue.createCommentVNode("", true)
        ]);
      };
    }
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
          ((_b2 = (_a2 = props.card) == null ? void 0 : _a2.file) == null ? void 0 : _b2.url) ? (vue.openBlock(), vue.createElementBlock("img", {
            key: 0,
            src: (_d = (_c2 = props.card) == null ? void 0 : _c2.file) == null ? void 0 : _d.url,
            alt: vue.unref(imageAlternative),
            onLoad: onImgLoad,
            class: "tvk-thumbnail"
          }, null, 40, _hoisted_2$2)) : vue.createCommentVNode("", true),
          ((_e = props.card) == null ? void 0 : _e.title) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$1, [
            vue.createElementVNode("strong", null, vue.toDisplayString((_f = props.card) == null ? void 0 : _f.title), 1)
          ])) : vue.createCommentVNode("", true),
          ((_g = props.card) == null ? void 0 : _g.subTitle) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$1, vue.toDisplayString((_h = props.card) == null ? void 0 : _h.subTitle), 1)) : vue.createCommentVNode("", true),
          ((_j = (_i = props.card) == null ? void 0 : _i.file) == null ? void 0 : _j.description) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$1, vue.toDisplayString((_l = (_k = props.card) == null ? void 0 : _k.file) == null ? void 0 : _l.description), 1)) : vue.createCommentVNode("", true)
        ]);
      };
    }
  });
  ...
  const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const props = __props;
      const cards = vue.ref(props.carousel.cards);
      const cardsRefs = vue.ref([]);
      const carouselRef = vue.ref(null);
      const innerRef = vue.ref(null);
      const carouselStyles = vue.ref({});
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createElementVNode("div", {
            ...
            ref_key: "carouselRef",
            ref: carouselRef,
            style: vue.normalizeStyle(carouselStyles.value)
          }, [
            vue.createElementVNode("div", {
              class: "tvk-carousel-inner",
              ref_key: "innerRef",
              ref: innerRef,
              style: vue.normalizeStyle(innerStyles.value)
            }, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(cards.value, (card) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  vue.createVNode(_sfc_main$5, { card }, null, 8, ["card"])
                ]);
              }), 128))
            ], 4)
          ], 4),
          vue.createElementVNode("div", { class: "tvk-carousel-controls" }, [
            vue.createElementVNode("button", {
              class: "tvk-btn",
              onClick: prev
            }, "prev"),
      ...
      return (_ctx, _cache) => {
        ...
        return props.message.author !== vue.unref(MessageAuthor).user || !vue.unref(appOptions).preferences.messages.message.hideUserMessages ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          class: vue.normalizeClass(["tvk-message", {
            "tvk-message-user": props.message.author === vue.unref(MessageAuthor).user,
          ...
          vue.createElementVNode("div", _hoisted_1$1, [
              ...
              vue.unref(appOptions).preferences.messages.message.header.avatar.display ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
                !vue.unref(appOptions).preferences.messages.message.header.avatar.userImage && vue.unref(appOptions).preferences.messages.message.header.avatar.userIcon && props.message.author === vue.unref(MessageAuthor).user ? (vue.openBlock(), vue.createElementBlock("i", {
                  ...
                  class: vue.normalizeClass([
                    ...
                    vue.unref(appOptions).preferences.messages.message.header.avatar.userIcon
                  ])
                }, null, 2)) : vue.createCommentVNode("", true),
                vue.unref(appOptions).preferences.messages.message.header.avatar.userImage && props.message.author === vue.unref(MessageAuthor).user ? (vue.openBlock(), vue.createElementBlock("img", {
                  key: 1,
                  src: vue.unref(appOptions).preferences.messages.message.header.avatar.userImage.src,
                  style: vue.normalizeStyle({
                    width: vue.unref(appOptions).preferences.messages.message.header.avatar.userImage.width,
                    height: vue.unref(appOptions).preferences.messages.message.header.avatar.userImage.height
                  }),
                  role: "none"
                }, null, 12, _hoisted_4)) : vue.createCommentVNode("", true),
                !vue.unref(appOptions).preferences.messages.message.header.avatar.botImage && vue.unref(appOptions).preferences.messages.message.header.avatar.botIcon && props.message.author === vue.unref(MessageAuthor).bot ? (vue.openBlock(), vue.createElementBlock("i", {
                  key: 2,
                  class: vue.normalizeClass([
                    "tvk-message-header-avatar-bot",
                    vue.unref(appOptions).preferences.messages.message.header.avatar.botIcon
                  ])
                }, null, 2)) : vue.createCommentVNode("", true),
                vue.unref(appOptions).preferences.messages.message.header.avatar.botImage && props.message.author === vue.unref(MessageAuthor).bot ? (vue.openBlock(), vue.createElementBlock("img", {
                  key: 3,
                  src: vue.unref(appOptions).preferences.messages.message.header.avatar.botImage.src,
                  style: vue.normalizeStyle({
                    width: vue.unref(appOptions).preferences.messages.message.header.avatar.botImage.width,
                    height: vue.unref(appOptions).preferences.messages.message.header.avatar.botImage.height
                  }),
                  role: "none"
                }, null, 12, _hoisted_5)) : vue.createCommentVNode("", true)
              ])) : vue.createCommentVNode("", true),
              vue.unref(appOptions).preferences.messages.message.header.label.display ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6, [
                vue.createElementVNode("span", _hoisted_7, vue.toDisplayString(vue.unref(appOptions).wording.messages.message.header.labelUser), 1),
                vue.createElementVNode("span", _hoisted_8, vue.toDisplayString(vue.unref(appOptions).wording.messages.message.header.labelBot), 1)
              ])) : vue.createCommentVNode("", true)
            ])) : vue.createCommentVNode("", true),
            props.message.author !== vue.unref(MessageAuthor).app ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9, [
              props.message.type === vue.unref(MessageType).message ? (vue.openBlock(), vue.createBlock(_sfc_main$6, {
                key: 0,
                message: props.message
              }, null, 8, ["message"])) : vue.createCommentVNode("", true),
              props.message.type === vue.unref(MessageType).card ? (vue.openBlock(), vue.createBlock(_sfc_main$5, {
                key: 1,
                card: props.message
              }, null, 8, ["card"])) : vue.createCommentVNode("", true),
              props.message.type === vue.unref(MessageType).carousel ? (vue.openBlock(), vue.createBlock(_sfc_main$4, {
                key: 2,
                carousel: props.message
              }, null, 8, ["carousel"])) : vue.createCommentVNode("", true),
              props.message.type === vue.unref(MessageType).image ? (vue.openBlock(), vue.createBlock(_sfc_main$3, {
                key: 3,
                message: props.message
              }, null, 8, ["message"])) : vue.createCommentVNode("", true)
            ])) : vue.createCommentVNode("", true),
            props.message.author === vue.unref(MessageAuthor).app ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [
              ...
              props.message.type === vue.unref(MessageType).info ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 2,
          ...
          ((_a = props.message.footnotes) == null ? void 0 : _a.length) && vue.unref(appOptions).preferences.messages.footNotes.display && vue.unref(appOptions).preferences.messages.footNotes.displayOnMessageSide ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_15, [
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const appOptions = appOptionsSingleton.getOptions();
      const mainStore = useMainStore();
      let randomKey = vue.ref(getRandomKey());
      let isDisplayed = vue.ref(true);
      ...
      return (_ctx, _cache) => {
        return vue.unref(isDisplayed) ? (vue.openBlock(), vue.createElementBlock("div", {
          class: "tvk-wrapper",
          key: vue.unref(randomKey)
        }, [
          vue.unref(mainStore).getMessages.length || !vue.unref(appOptions).preferences.messages.hideIfNoMessages ? (vue.openBlock(), vue.createBlock(_sfc_main$1, { key: 0 })) : vue.createCommentVNode("", true),
  ...
  function mountApp(tockEndPoint, options) {
    if (appMemo == null ? void 0 : appMemo.unmount)
      appMemo.unmount();
    appMemo = vue.createApp(_sfc_main);
  ...
  exports2.addTvkMessage = addTvkMessage;
  exports2.getTvkCurrentOptions = getTvkCurrentOptions;
  exports2.getTvkDefaultOptions = getTvkDefaultOptions;
  exports2.reload = reload;
  exports2.renderChat = renderChat;
  exports2.updateTvkOption = updateTvkOption;
